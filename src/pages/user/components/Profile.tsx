...
import { modalAtom, nicknameValidAtom, userCollection, userRecordId } from '@/stores/stores';
...
const ProfileComponent = () => {
  ...
  return (
    <>
      <div className="m-18pxr border-2 border-transparent focus-within:border-primary focus-within:border-2 rounded-full relative ">
      ...
      {userName ? (
        <button className="text-title-3-em" onClick={onClickNickName}>
          {userName}
        </button>
      ) : (
      ...
      <TwoButtonModal
        ...
        component={<NicknameComponent placeholder={randomName} label={false} onNicknameChange={handleNicknameChange} />}
